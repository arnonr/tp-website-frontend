  ...
  data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000">
    <div class="product__thumb w-img p-relative fix">
      ...
      <div class="product__action d-flex flex-column flex-wrap">
        ...
        <button type="button" class="product-action-btn" data-bs-toggle="modal" :data-bs-target="`#productModal-${item.id}`">
        ...
        <button type="button" class="product-action-btn">
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M1.48883 3.58386L14 3.58386" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
