<template>
  <section :class="`contact__area ${el_style? 'pt-110 pb-100' : 'pt-150 pb-150'} p-relative z-index-1`">
        ...
        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-6">
          <div class="contact__wrapper-9">
            ...
            <div class="contact__list-9 mr-100">
              <div
                class="contact__list-item-9 flex-wrap d-flex align-items-start"
              >
                <div class="contact__list-icon-9">
                  <span>
                    ...
                    >
                      ...
                      <path
                        opacity="0.4"
                        d="M18.9992 7.3C18.9992 3.817 16.1822 1 12.6992 1"
                        stroke="currentColor"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                    ...
                    <img
                      class="contact-icon-shape"
                      src="~/assets/img/contact/contact-icon-shape.png"
                      alt="shape"
                    />
                  </span>
                </div>
                <div class="contact__list-content-9">
                  <h5>Phone Number</h5>
                  <p><a href="tel:67000-000-9012">+67000-000 9012</a></p>
                </div>
              </div>
              <div
                class="contact__list-item-9 flex-wrap d-flex align-items-start"
...
<script>
import PersonalPortContactForm from "../forms/PersonalPortContactForm.vue";
...
export default {
  ...
  components: { PersonalPortContactForm },
};
</script>
