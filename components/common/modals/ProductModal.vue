<template>
  <div class="product__modal modal fade" :id="modal_id" tabindex="-1" aria-labelledby="productModal"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="product__modal-wrapper">
          <div class="product__modal-close">
            <button class="product__modal-close-btn" type="button" data-bs-toggle="modal"
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="product__modal-thumb-wrapper">
                <div class="product__details-thumb-tab mr-40">
                  <div class="product__details-thumb-content w-img">
                    <div class="tab-content" id="nav-tabContent">
                      <div class="active-img">
                        <img :src="active_img" alt="img">
                      </div>
                    </div>
                  </div>
                    ...
                    <nav>
                      <div class="nav nav-tabs justify-content-sm-between">
                            ...
                            v-for="(img, i) in item.relatedImages"
                              :key="i"
                              :class="`nav-link ${ img.img === active_img ? 'active' : '' }`"
                              @click="handleActiveImg(img.img)"
                            >
                              <img
                                :src="img.img"
                                alt="image"
            ...
            <div class="col-lg-6">
              <div class="product__details-wrapper">
                <h3 class="product__details-title">{{item.title}}</h3>
                ...
                <div class="product__details-action d-flex flex-wrap align-items-center">
                  ...
                  <button type="button" class="product-action-btn">
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M1.48883 3.58386L14 3.58386" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M4.07452 8.32166L1.4889 10.9058L4.07452 13.4899" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M14 10.906H1.48883" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
