    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xxl-12">
          <div
            class="testimonial__slider-6"
            data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000"
          >
            <ClientOnly>
              <Swiper
                class="testimonial__slider-active-6 swiper-container"
                :slidesPerView="4"
                :spaceBetween="20"
                :loop="true"
                :modules="modules"
              ...
              >
                <SwiperSlide
                  ...
                  :key="item.id"
                >
                  <div class="testimonial__item-6 transition-3 mb-75">
                    ...
                    <div
                      class="testimonial__avater-6 d-flex align-items-center"
                    >
