<template>
  <section class="product__details-area pb-115">
    <div class="container">
        <div class="row">
          <div class="col-xl-7 col-lg-6">
              <div class="product__details-thumb-tab mr-70">
                <div class="product__details-thumb-content w-img">
                    <div style="max-height: 575px;overflow: hidden;">
                      <img :src="active_img" alt="prd image">
                    </div>                            
                </div>
