            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="faq__tab-content tp-accordion">
                        <div class="accordion" id="general_accordion_p" v-if="departments.length != 0">
                            <div class="accordion-item" v-for="(dp, index) in departments" :key="index"
                                ...
                                <div :id="'collapse' + dp.id + '_p'" :class="index == 0
                                    ...
                                    <div class="accordion-body">
                                        <div class="row" v-if="
                                            dp.id != 1
                                        ">
                                            <div v-for="(it, i) in dp.teamItems" :key="i" class="team__item-10 col-lg-3"
                                                style="
                                                ...
                                                <div class="team__thumb-10 p-relative m-img">
                                                    ...
                                                    <div class="team__contact-overlay">
                                                        ...
                                                        <div class="team__contact-wrapper">
                                                            ...
                                                            <p class="team-email mt-20" style="
...
<template v-for="(it, i) in dp.teamItems" :key="i">
                                                <div
                                                    v-if="
                                                        it.sub_department ==
                                                        'งานทรัพยากรมนุษย์และการบริหารสำนักงาน'
...
<template v-for="(it, i) in dp.teamItems" :key="i">
                                        ...
                                        <!-- <div class="row" v-if="dp.id == 4">
                                            <div
                                                ...
                                                style="margin-top: 40px"
                                            >
                                                <h3>หัวหน้างานบริการวิชาการและอุตสาหกรรมสัมพันธ์</h3>
                                            </div>
                                            <template
                                                v-for="(it, i) in dp.teamItems"
                                                :key="i"
                                            >
                                                <div
                                                    v-if="
                                                        it.sub_department ==
                                                        'หัวหน้างานบริการวิชาการและอุตสาหกรรมสัมพันธ์'
                                                    "
                                                    class="team__item-10 col-lg-3"
                                                    style="
                                                        margin-top: 20px !important;
                                            ...
                                            >
                                                <h3>
                                                    งานบริการวิชาการประเภทการฝึกอบรม สัมมนา อภิปราย และบรรยาย
                                                </h3>
                                            </div>
                                            <template
                                                v-for="(it, i) in dp.teamItems"
                                            ...
                                            <div
                                                ...
                                                style="margin-top: 40px"
                                            >
                                                <h3>ศูนย์ปฏิบัติการเทคโนโลยีเซมิคอนดักเตอร์</h3>
                                            </div>
                                            <template
                                                v-for="(it, i) in dp.teamItems"
                                                :key="i"
                                            >
                                                <div
                                                    v-if="
                                                        it.sub_department ==
                                                        'ศูนย์ปฏิบัติการเทคโนโลยีเซมิคอนดักเตอร์'
                                                    "
                                                    class="team__item-10 col-lg-3"
                                                    style="
                                                        margin-top: 20px !important;
                                        ...
                                        ">
                                            ...
                                            <div class="col-md-12">
                                                <div class="text-center row justify-content-md-center">
                                                    <div class="team__item-10 col-lg-3" style="
                                                            margin-top: 20px !important;
                                                        ">
                                                        <div class="team__thumb-10 p-relative m-img">
                                                            <img :src="dp
...
// const filteredTeamItems = computed((its, sub_department) => {
//     console.log(its)
//     return dp.value.teamItems.filter((it) => it.sub_department === "งานอาคาร");
// });
