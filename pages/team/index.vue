              ...
              >
                ...
                >
                  <div class="accordion-body">
                    ...
                    <div
                      class="row mt-20"
                      v-if="dp.teamItems.length != 0 && dp.id == 1"
                    >
                      <!-- ผอ. -->
                      <div class="col-md-12">
                        <div class="text-center row justify-content-md-center">
                          <div class="team__item-10 col-lg-3 mt-20">
                            <div class="team__thumb-10 p-relative m-img">
                              <nuxt-link href="/team-details">
                                <img :src="dp.teamItems[0].team_file" alt="" />
                              </nuxt-link>
                            ...
                            <div class="team__content-10 text-center">
                              <h3 class="team__title-10 pb-20">
                                {{
                                  dp.teamItems[0].prefix +
                                  dp.teamItems[0].firstname +
                                  " " +
                                  dp.teamItems[0].surname
                                }}
                              </h3>
                              <span class="team__designation-10">
                                {{ dp.teamItems[0].position }}
                                <br />
                                {{ dp.teamItems[0].position_level }}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="row justify-content-md-center">
                          ...
                          <div class="team__item-10 col-lg-3 mt-20">
                            <div class="team__thumb-10 p-relative m-img">
                              <nuxt-link href="/team-details">
                                <img :src="dp.teamItems[1].team_file" alt="" />
                              </nuxt-link>
                            ...
                            <div class="team__content-10 text-center">
                              <h3 class="team__title-10 pb-20">
                                {{
                                  dp.teamItems[1].prefix +
                                  dp.teamItems[1].firstname +
                                  " " +
                                  dp.teamItems[1].surname
                                }}
                              </h3>
                              <span class="team__designation-10">
                                {{ dp.teamItems[1].position }}
                                <br />
                                {{ dp.teamItems[1].position_level }}
                              </span>
                            </div>
                          </div>
                          <!-- รอง 2 -->
                          <div class="team__item-10 col-lg-3 mt-20">
                            <div class="team__thumb-10 p-relative m-img">
                              <nuxt-link href="/team-details">
                                <img :src="dp.teamItems[2].team_file" alt="" />
                              </nuxt-link>
                            ...
                            <div class="team__content-10 text-center">
                              <h3 class="team__title-10 pb-20">
                                {{
                                  dp.teamItems[2].prefix +
                                  dp.teamItems[2].firstname +
                                  " " +
                                  dp.teamItems[2].surname
                                }}
                              </h3>
                              <span class="team__designation-10">
                                {{ dp.teamItems[2].position }}
                                <br />
                                {{ dp.teamItems[2].position_level }}
                              </span>
                            </div>
                          </div>
                          <!-- รอง 3 -->
                          <div class="team__item-10 col-lg-3 mt-20">
                            <div class="team__thumb-10 p-relative m-img">
                              <nuxt-link href="/team-details">
                                <img :src="dp.teamItems[3].team_file" alt="" />
                              </nuxt-link>
                            ...
                            <div class="team__content-10 text-center">
                              <h3 class="team__title-10 pb-20">
                                {{
                                  dp.teamItems[3].prefix +
                                  dp.teamItems[3].firstname +
                                  " " +
                                  dp.teamItems[3].surname
                                }}
                              </h3>
                              <span class="team__designation-10">
                                {{ dp.teamItems[3].position }}
                                <br />
                                {{ dp.teamItems[3].position_level }}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="text-center row justify-content-md-center">
                          <div class="team__item-10 col-lg-3 mt-20">
                            <div class="team__thumb-10 p-relative m-img">
                              <nuxt-link href="/team-details">
                                <img :src="dp.teamItems[4].team_file" alt="" />
                              </nuxt-link>
                            ...
                            <div class="team__content-10 text-center">
                              <h3 class="team__title-10 pb-20">
                                {{
                                  dp.teamItems[4].prefix +
                                  dp.teamItems[4].firstname +
                                  " " +
                                  dp.teamItems[4].surname
                                }}
                              </h3>
                              <span class="team__designation-10">
                                <!-- {{ dp.teamItems[4].position }} -->
                                <!-- <br /> -->
                                {{ dp.teamItems[4].position_level }}
                              </span>
                            </div>
                          </div>
                        </div>
...
const { data: resDepartments } = await useAsyncData("department-team", async () => {
  let data = await $fetch(`${runtimeConfig.public.apiBase}/department-team`, {
    params: {
      is_publish: 1,
    },
  });
