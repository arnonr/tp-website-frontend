                ...
                <div class="col-xxl-12">
                    <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list">
                            ...
                            ></span>
                            <span> รายการข้อมูล{{ $name_page }} </span>
                        </div>
                    </div>
                </div>
            </div>
...
const $name_page = "หลักสูตร";
const $name_page_en = "course";
const items = ref([]);
...
const fetchItems = async () => {
    ...
    let data = await $fetch(`${apiBase}/${$name_page_en}`, {
        params: params,
...
const onDelete = async (id) => {
    await $fetch(`${apiBase}/${$name_page_en}/${id}`, {
        method: "delete",
    })
        .then((res) => {
            if (res.msg == "success") {
